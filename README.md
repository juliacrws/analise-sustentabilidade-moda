...
## 📊 Dataset
Os dados utilizados são do dataset *"Sustainable Fashion: Eco-Friendly Trends"* ([Kaggle](https://www.kaggle.com/)). A base contém 5.000 registros de marcas globais, mensurando emissões em Toneladas Métricas (MT) e consumo hídrico em Litros.
...
* Lógica condicional automatizada para geração de insights no terminal.
